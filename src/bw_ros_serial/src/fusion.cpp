...
// 设置串口参数
serial::Serial imu_ser("/dev/ttyUSB4", 115200, serial::Timeout::simpleTimeout(100));
...
int main(int argc, char** argv)
{
    ...
    ofstream outfile("/home/main/oins/src/bw_ros_serial/data/230704/record_3.csv");
    outfile << "行驶状态,"
            << "编码器速度,"
            << "惯性导航解算速度,"
            << "slam位移,"
    ...
    while(true)
    {
        ...
        AdsVariable<int32_t> state {route, 0X4020, 108};
