...
{
/* 
    ofstream outfile("/home/main/oins/src/bw_ros_serial/data/230726/2/record_9.csv");
    outfile << "行驶状态,"
            << "编码器速度,"
            // << "惯性导航解算速度,"
            // << "惯性导航解算位移,"
 ...
 */
    ...
    {
        // 读取plc地址中存放的状态数据
        AdsVariable<uint16_t> state {route, 0X4020, 108};
        // 给状态赋值
        ...
        // 当plc中的编码器速度小于0.0015m/s时，认为停止，赋值给交叉验证的状态量
...
/* 
        ...
        if (dax <= 0.005 && abs(ax) <= 0.01 && movement_state == 0)
 ...
 */        
        ...
        // cout << "组合导航位移: \n" << X << "\n" << endl;
        // cout << "i: " << i << "\n" << endl;
        // cout << "slam位移: \n" << displacement_slam << endl;
        cout << "------" << endl;
/* 
        outfile << movement_state << ","
                << encoder_speed << ","
                // << velocity_x << ","
                // << displacement_slam << ","
                // << displacement_x << ","
